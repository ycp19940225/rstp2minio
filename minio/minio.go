...
func (m *Minio) PutObject(ctx context.Context, object string, data io.Reader, size int64, opts minio.PutObjectOptions) (*minio.UploadInfo, error) {
	info, err := m.client.PutObject(ctx, m.ops.bucket, object, data, size, opts)
	if err != nil {
		return nil, err
	}
	return &info, nil
